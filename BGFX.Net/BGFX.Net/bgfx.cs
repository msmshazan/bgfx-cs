...
namespace BGFX.Net
{
	public static partial class BGFX
	{
		...
		public struct Caps
		{
			...
			public byte numGPUs;
			public _uint_e_FixedBuffer_4 gpu;
			public Limits limits;
			public _ushort_e_FixedBuffer_85 formats;
		}

		public unsafe struct _ushort_e_FixedBuffer_85
		{
			...
			public ulong ulong8;
			public ulong ulong9;
			public ulong ulong10;
			public ulong ulong11;
			public ulong ulong12;
			public ulong ulong13;
			public ulong ulong14;
			public ulong ulong15;
			public ulong ulong16;
			public ulong ulong17;
			public ulong ulong18;
			public ulong ulong19;
			public ulong ulong20;

			public ref ushort this[int index]
			{
				get
				{
					fixed (ushort* ptr = &ushort0)
					{
		...
		public unsafe struct _uint_e_FixedBuffer_4
		{
			public uint uint0;
			public uint uint1;
			public uint uint2;
		...
		public unsafe struct _uint_e_FixedBuffer_5
		{
			public uint uint0;
			public uint uint1;
			public uint uint2;
		...
		public unsafe struct _byte_e_FixedBuffer_256
		{
			public byte byte0;
			public byte byte1;
			public byte byte2;
			...
			public ulong ulong19;
			public ulong ulong20;
			public ulong ulong21;
			public ulong ulong22;
			public ulong ulong23;
			public ulong ulong24;
			public ulong ulong25;
			public ulong ulong26;
			public ulong ulong27;
			public ulong ulong28;
			public ulong ulong29;
			public ulong ulong30;

			public ref byte this[int index]
			{
				get
				{
					fixed (byte* ptr = &byte0)
					{
						return ref ptr[index];
					}
				}
		...
		{
			private IntPtr caps;
			public unsafe ref Caps Caps 
			{ 
				get
				{
					return ref Unsafe.AsRef<Caps>(caps.ToPointer());
				} 
			}
		...
		{
			private IntPtr data;
			public unsafe ref byte[] Data
			{
				get
				{
					return ref Unsafe.AsRef<byte []>(data.ToPointer());
				}
			}
		...
		{
			private IntPtr data;
			public unsafe ref ushort[] Data
			{
				get
				{
					return ref Unsafe.AsRef<ushort[]>(data.ToPointer());
				}
			}
			public uint size;
		...
		{
			public IntPtr data;
			public unsafe ref T[] Data<T>(int index) where T : struct 
			{
		...
		{
			public _byte_e_FixedBuffer_256 name;
		...
		public struct Stats
		{
			...
			public _uint_e_FixedBuffer_5 numPrims;
			...
			public IntPtr viewStats;
			public byte numEncoders;
			public IntPtr encoderStats;
		}
		...
		public struct VertexLayout
		{
			public uint hash;
			public ushort stride;
			public _ushort_e_FixedBuffer_18 offset;
			public _ushort_e_FixedBuffer_18 attributes;
		}

		public unsafe struct _ushort_e_FixedBuffer_18
		{
			public ushort ushort0;
		...
		public static extern void attachment_init(ref Attachment _this, TextureHandle _handle, Access _access, ushort _layer, ushort _mip, byte _resolve);
		...
		public static extern ref VertexLayout vertex_layout_add(ref VertexLayout _this, Attrib _attrib, byte _num, AttribType _type, bool _normalized, bool _asInt);
		...
		public static extern void vertex_layout_decode(ref VertexLayout _this, Attrib _attrib,ref byte _num,ref AttribType _type,ref bool _normalized,ref bool _asInt);
		...
		public static extern void vertex_pack(float _input, bool _inputNormalized, Attrib _attr, ref VertexLayout _layout, IntPtr _data, uint _index);
		...
		public static extern void vertex_unpack(float _output, Attrib _attr, ref VertexLayout _layout, IntPtr _data, uint _index);
		...
		public static extern void vertex_convert(ref VertexLayout _dstLayout, IntPtr _dstData, ref VertexLayout _srcLayout, IntPtr _srcData, uint _num);
		...
		public static extern ushort weld_vertices(ref ushort[] _output, ref VertexLayout _layout, IntPtr _data, ushort _num, float _epsilon);
		...
		public static extern uint topology_convert(TopologyConvert _conversion, IntPtr _dst, uint _dstSize, IntPtr _indices, uint _numIndices, bool _index32);
		...
		public static extern void topology_sort_tri_list(TopologySort _sort, IntPtr _dst, uint _dstSize, float _dir, float _pos, IntPtr _vertices, uint _stride, IntPtr _indices, uint _numIndices, bool _index32);
		...
		[return: MarshalAs(UnmanagedType.I1)]
		public static extern bool init(ref Init _init);
		...
		public static extern VertexBufferHandle create_vertex_buffer(ref Memory _mem, ref VertexLayout _layout, ushort _flags);
		...
		public static extern DynamicIndexBufferHandle create_dynamic_index_buffer_mem(ref Memory _mem, ushort _flags);
		...
		public static extern void update_dynamic_index_buffer(DynamicIndexBufferHandle _handle, uint _startIndex, ref Memory _mem);
		...
		public static extern DynamicVertexBufferHandle create_dynamic_vertex_buffer(uint _num, ref VertexLayout _layout, ushort _flags);
		...
		public static extern DynamicVertexBufferHandle create_dynamic_vertex_buffer_mem(ref Memory _mem, ref VertexLayout _layout, ushort _flags);
		...
		public static extern void update_dynamic_vertex_buffer(DynamicVertexBufferHandle _handle, uint _startVertex, ref Memory _mem);
		...
		public static extern uint get_avail_transient_vertex_buffer(uint _num, ref VertexLayout _layout);
		...
		public static extern void alloc_transient_index_buffer(ref TransientIndexBuffer _tib, uint _num);
		...
		public static extern void alloc_transient_vertex_buffer(ref TransientVertexBuffer _tvb, uint _num, ref VertexLayout _layout);
		...
		[return: MarshalAs(UnmanagedType.I1)]
		public static extern bool alloc_transient_buffers(ref TransientVertexBuffer _tvb, ref VertexLayout _layout, uint _numVertices, ref TransientIndexBuffer _tib, uint _numIndices);
		...
		public static extern void alloc_instance_data_buffer(ref InstanceDataBuffer _idb, uint _num, ushort _stride);
		...
		public static extern ShaderHandle create_shader(ref Memory _mem);
		...
		public static extern ushort get_shader_uniforms(ShaderHandle _handle, ref UniformHandle _uniforms, ushort _max);
		...
		public static extern void calc_texture_size(ref TextureInfo _info, ushort _width, ushort _height, ushort _depth, bool _cubeMap, bool _hasMips, ushort _numLayers, TextureFormat _format);
		...
		public static extern TextureHandle create_texture(ref Memory _mem, ulong _flags, byte _skip, ref TextureInfo _info);
		...
		public static extern TextureHandle create_texture_2d(ushort _width, ushort _height, bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags, ref Memory _mem);
		...
		public static extern TextureHandle create_texture_3d(ushort _width, ushort _height, ushort _depth, bool _hasMips, TextureFormat _format, ulong _flags, ref Memory _mem);
		...
		public static extern TextureHandle create_texture_cube(ushort _size, bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags, ref Memory _mem);
		...
		public static extern void update_texture_2d(TextureHandle _handle, ushort _layer, byte _mip, ushort _x, ushort _y, ushort _width, ushort _height, ref Memory _mem, ushort _pitch);
		...
		public static extern void update_texture_3d(TextureHandle _handle, byte _mip, ushort _x, ushort _y, ushort _z, ushort _width, ushort _height, ushort _depth, ref Memory _mem);
		...
		public static extern void update_texture_cube(TextureHandle _handle, ushort _layer, byte _side, byte _mip, ushort _x, ushort _y, ushort _width, ushort _height, ref Memory _mem, ushort _pitch);
		...
		public static extern uint read_texture(TextureHandle _handle, IntPtr _data, byte _mip);
		...
		public static extern IntPtr get_direct_access_ptr(TextureHandle _handle);
		...
		public static extern FrameBufferHandle create_frame_buffer_from_handles(byte _num, ref TextureHandle _handles, bool _destroyTexture);
		...
		public static extern FrameBufferHandle create_frame_buffer_from_attachment(byte _num, ref Attachment _attachment, bool _destroyTexture);
		...
		public static extern FrameBufferHandle create_frame_buffer_from_nwh(IntPtr _nwh, ushort _width, ushort _height, TextureFormat _format, TextureFormat _depthFormat);
		...
		public static extern void get_uniform_info(UniformHandle _handle, ref UniformInfo _info);
		...
		public static extern OcclusionQueryResult get_result(OcclusionQueryHandle _handle,ref int _result);
		...
		public static extern void set_view_transform(ushort _id, IntPtr _view, IntPtr _proj);
		...
		public static extern void set_view_order(ushort _id, ushort _num,ref ushort _order);
		...
		public static extern ref Encoder encoder_begin(bool _forThread);
		...
		public static extern void encoder_end(ref Encoder _encoder);
		...
		public static extern void encoder_set_marker(ref Encoder _this, [MarshalAs(UnmanagedType.LPStr)] string _marker);
		...
		public static extern void encoder_set_state(ref Encoder _this, ulong _state, uint _rgba);
		...
		public static extern void encoder_set_condition(ref Encoder _this, OcclusionQueryHandle _handle, bool _visible);
		...
		public static extern void encoder_set_stencil(ref Encoder _this, uint _fstencil, uint _bstencil);
		...
		public static extern ushort encoder_set_scissor(ref Encoder _this, ushort _x, ushort _y, ushort _width, ushort _height);
		...
		public static extern void encoder_set_scissor_cached(ref Encoder _this, ushort _cache);
		...
		public static extern uint encoder_set_transform(ref Encoder _this, IntPtr _mtx, ushort _num);
		...
		public static extern void encoder_set_transform_cached(ref Encoder _this, uint _cache, ushort _num);
		...
		public static extern uint encoder_alloc_transform(ref Encoder _this, ref Transform _transform, ushort _num);
		...
		public static extern void encoder_set_uniform(ref Encoder _this, UniformHandle _handle, IntPtr _value, ushort _num);
		...
		public static extern void encoder_set_index_buffer(ref Encoder _this, IndexBufferHandle _handle, uint _firstIndex, uint _numIndices);
		...
		public static extern void encoder_set_dynamic_index_buffer(ref Encoder _this, DynamicIndexBufferHandle _handle, uint _firstIndex, uint _numIndices);
		...
		public static extern void encoder_set_transient_index_buffer(ref Encoder _this, ref TransientIndexBuffer _tib, uint _firstIndex, uint _numIndices);
		...
		public static extern void encoder_set_vertex_buffer(ref Encoder _this, byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
		...
		public static extern void encoder_set_dynamic_vertex_buffer(ref Encoder _this, byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
		...
		public static extern void encoder_set_transient_vertex_buffer(ref Encoder _this, byte _stream, ref TransientVertexBuffer _tvb, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
		...
		public static extern void encoder_set_vertex_count(ref Encoder _this, uint _numVertices);
		...
		public static extern void encoder_set_instance_data_buffer(ref Encoder _this, ref InstanceDataBuffer _idb, uint _start, uint _num);
		...
		public static extern void encoder_set_instance_data_from_vertex_buffer(ref Encoder _this, VertexBufferHandle _handle, uint _startVertex, uint _num);
		...
		public static extern void encoder_set_instance_data_from_dynamic_vertex_buffer(ref Encoder _this, DynamicVertexBufferHandle _handle, uint _startVertex, uint _num);
		...
		public static extern void encoder_set_instance_count(ref Encoder _this, uint _numInstances);
		...
		public static extern void encoder_set_texture(ref Encoder _this, byte _stage, UniformHandle _sampler, TextureHandle _handle, uint _flags);
		...
		public static extern void encoder_touch(ref Encoder _this, ushort _id);
		...
		public static extern void encoder_submit(ref Encoder _this, ushort _id, ProgramHandle _program, uint _depth, bool _preserveState);
		...
		public static extern void encoder_submit_occlusion_query(ref Encoder _this, ushort _id, ProgramHandle _program, OcclusionQueryHandle _occlusionQuery, uint _depth, bool _preserveState);
		...
		public static extern void encoder_submit_indirect(ref Encoder _this, ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num, uint _depth, bool _preserveState);
		...
		public static extern void encoder_set_compute_index_buffer(ref Encoder _this, byte _stage, IndexBufferHandle _handle, Access _access);
		...
		public static extern void encoder_set_compute_vertex_buffer(ref Encoder _this, byte _stage, VertexBufferHandle _handle, Access _access);
		...
		public static extern void encoder_set_compute_dynamic_index_buffer(ref Encoder _this, byte _stage, DynamicIndexBufferHandle _handle, Access _access);
		...
		public static extern void encoder_set_compute_dynamic_vertex_buffer(ref Encoder _this, byte _stage, DynamicVertexBufferHandle _handle, Access _access);
		...
		public static extern void encoder_set_compute_indirect_buffer(ref Encoder _this, byte _stage, IndirectBufferHandle _handle, Access _access);
		...
		public static extern void encoder_set_image(ref Encoder _this, byte _stage, TextureHandle _handle, byte _mip, Access _access, TextureFormat _format);
		...
		public static extern void encoder_dispatch(ref Encoder _this, ushort _id, ProgramHandle _program, uint _numX, uint _numY, uint _numZ);
		...
		public static extern void encoder_dispatch_indirect(ref Encoder _this, ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num);
		...
		public static extern void encoder_discard(ref Encoder _this);
		...
		public static extern void encoder_blit(ref Encoder _this, ushort _id, TextureHandle _dst, byte _dstMip, ushort _dstX, ushort _dstY, ushort _dstZ, TextureHandle _src, byte _srcMip, ushort _srcX, ushort _srcY, ushort _srcZ, ushort _width, ushort _height, ushort _depth);
		...
		public static extern ref InternalData get_internal_data();
		...
		public static extern uint set_transform(IntPtr _mtx, ushort _num);
		...
		public static extern void set_transient_index_buffer(ref TransientIndexBuffer _tib, uint _firstIndex, uint _numIndices);
		...
		public static extern void set_transient_vertex_buffer(byte _stream, ref TransientVertexBuffer _tvb, uint _startVertex, uint _numVertices);
		...
		public static extern void submit_occlusion_query(ushort _id, ProgramHandle _program, OcclusionQueryHandle _occlusionQuery, uint _depth, bool _preserveState);
		...
		public static extern void submit_indirect(ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num, uint _depth, bool _preserveState);
		...
		public static extern void dispatch_indirect(ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num);
