...
namespace BGFX.Net
{
    ...
    public static partial class BGFX
    {
        ...
        private const string DllName = "BGFX.Interop.dll";
        ...
        [DllImport(DllName, EntryPoint = "bgfx_update_dynamic_index_buffer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern void update_dynamic_index_buffer(DynamicIndexBufferHandle _handle, uint _startIndex,
            ref Memory _mem);
        ...
        [DllImport(DllName, EntryPoint = "bgfx_create_dynamic_vertex_buffer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern DynamicVertexBufferHandle create_dynamic_vertex_buffer(uint _num, ref VertexLayout _layout,
            ushort _flags);
        ...
        [DllImport(DllName, EntryPoint = "bgfx_create_dynamic_vertex_buffer_mem",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern DynamicVertexBufferHandle create_dynamic_vertex_buffer_mem(ref Memory _mem,
            ref VertexLayout _layout, ushort _flags);
        ...
        [DllImport(DllName, EntryPoint = "bgfx_update_dynamic_vertex_buffer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern void update_dynamic_vertex_buffer(DynamicVertexBufferHandle _handle, uint _startVertex,
            ref Memory _mem);
        ...
        [DllImport(DllName, EntryPoint = "bgfx_alloc_transient_vertex_buffer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern void alloc_transient_vertex_buffer(ref TransientVertexBuffer _tvb, uint _num,
            ref VertexLayout _layout);
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool alloc_transient_buffers(ref TransientVertexBuffer _tvb, ref VertexLayout _layout,
            uint _numVertices, ref TransientIndexBuffer _tib, uint _numIndices);
        ...
        public static extern void calc_texture_size(ref TextureInfo _info, ushort _width, ushort _height, ushort _depth,
        ...
        public static extern TextureHandle create_texture(ref Memory _mem, ulong _flags, byte _skip,
            ref TextureInfo _info);
        ...
        public static extern TextureHandle create_texture_2d(ushort _width, ushort _height, bool _hasMips,
            ushort _numLayers, TextureFormat _format, ulong _flags, ref Memory _mem);
        ...
        public static extern TextureHandle create_texture_3d(ushort _width, ushort _height, ushort _depth,
            bool _hasMips, TextureFormat _format, ulong _flags, ref Memory _mem);
        ...
        public static extern TextureHandle create_texture_cube(ushort _size, bool _hasMips, ushort _numLayers,
            TextureFormat _format, ulong _flags, ref Memory _mem);
        ...
        public static extern void update_texture_2d(TextureHandle _handle, ushort _layer, byte _mip, ushort _x,
            ushort _y, ushort _width, ushort _height, ref Memory _mem, ushort _pitch);
        ...
        public static extern void update_texture_3d(TextureHandle _handle, byte _mip, ushort _x, ushort _y, ushort _z,
            ushort _width, ushort _height, ushort _depth, ref Memory _mem);
        ...
        public static extern void update_texture_cube(TextureHandle _handle, ushort _layer, byte _side, byte _mip,
            ushort _x, ushort _y, ushort _width, ushort _height, ref Memory _mem, ushort _pitch);
        ...
        [DllImport(DllName, EntryPoint = "bgfx_create_frame_buffer_from_handles",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern FrameBufferHandle create_frame_buffer_from_handles(byte _num, ref TextureHandle _handles,
        ...
        [DllImport(DllName, EntryPoint = "bgfx_create_frame_buffer_from_attachment",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern FrameBufferHandle create_frame_buffer_from_attachment(byte _num,
            ref Attachment _attachment, bool _destroyTexture);
        ...
        [DllImport(DllName, EntryPoint = "bgfx_create_frame_buffer_from_nwh",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern FrameBufferHandle create_frame_buffer_from_nwh(IntPtr _nwh, ushort _width, ushort _height,
            TextureFormat _format, TextureFormat _depthFormat);
        ...
        public static extern void
            encoder_set_marker(ref Encoder _this, [MarshalAs(UnmanagedType.LPStr)] string _marker);
        ...
        ///      `BGFX_STATE_BLEND_FUNC(_src, dst)`,
        ...
        public static extern ushort encoder_set_scissor(ref Encoder _this, ushort _x, ushort _y, ushort _width,
            ushort _height);
        ...
        public static extern void encoder_set_uniform(ref Encoder _this, UniformHandle _handle, IntPtr _value,
            ushort _num);
        ...
        public static extern void encoder_set_index_buffer(ref Encoder _this, IndexBufferHandle _handle,
        ...
        [DllImport(DllName, EntryPoint = "bgfx_encoder_set_dynamic_index_buffer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern void encoder_set_dynamic_index_buffer(ref Encoder _this, DynamicIndexBufferHandle _handle,
            uint _firstIndex, uint _numIndices);
        ...
        [DllImport(DllName, EntryPoint = "bgfx_encoder_set_transient_index_buffer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern void encoder_set_transient_index_buffer(ref Encoder _this, ref TransientIndexBuffer _tib,
            uint _firstIndex, uint _numIndices);
        ...
        public static extern void encoder_set_vertex_buffer(ref Encoder _this, byte _stream, VertexBufferHandle _handle,
        ...
        [DllImport(DllName, EntryPoint = "bgfx_encoder_set_dynamic_vertex_buffer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern void encoder_set_dynamic_vertex_buffer(ref Encoder _this, byte _stream,
        ...
        [DllImport(DllName, EntryPoint = "bgfx_encoder_set_transient_vertex_buffer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern void encoder_set_transient_vertex_buffer(ref Encoder _this, byte _stream,
            ref TransientVertexBuffer _tvb, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
        ...
        [DllImport(DllName, EntryPoint = "bgfx_encoder_set_instance_data_buffer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern void encoder_set_instance_data_buffer(ref Encoder _this, ref InstanceDataBuffer _idb,
        ...
        [DllImport(DllName, EntryPoint = "bgfx_encoder_set_instance_data_from_vertex_buffer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern void encoder_set_instance_data_from_vertex_buffer(ref Encoder _this,
        ...
        [DllImport(DllName, EntryPoint = "bgfx_encoder_set_instance_data_from_dynamic_vertex_buffer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern void encoder_set_instance_data_from_dynamic_vertex_buffer(ref Encoder _this,
        ...
        public static extern void encoder_set_texture(ref Encoder _this, byte _stage, UniformHandle _sampler,
        ...
        public static extern void encoder_submit(ref Encoder _this, ushort _id, ProgramHandle _program, uint _depth,
            bool _preserveState);
        ...
        [DllImport(DllName, EntryPoint = "bgfx_encoder_submit_occlusion_query",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern void encoder_submit_occlusion_query(ref Encoder _this, ushort _id, ProgramHandle _program,
        ...
        public static extern void encoder_submit_indirect(ref Encoder _this, ushort _id, ProgramHandle _program,
        ...
        [DllImport(DllName, EntryPoint = "bgfx_encoder_set_compute_index_buffer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern void encoder_set_compute_index_buffer(ref Encoder _this, byte _stage,
        ...
        [DllImport(DllName, EntryPoint = "bgfx_encoder_set_compute_vertex_buffer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern void encoder_set_compute_vertex_buffer(ref Encoder _this, byte _stage,
        ...
        [DllImport(DllName, EntryPoint = "bgfx_encoder_set_compute_dynamic_index_buffer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern void encoder_set_compute_dynamic_index_buffer(ref Encoder _this, byte _stage,
        ...
        [DllImport(DllName, EntryPoint = "bgfx_encoder_set_compute_dynamic_vertex_buffer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern void encoder_set_compute_dynamic_vertex_buffer(ref Encoder _this, byte _stage,
        ...
        [DllImport(DllName, EntryPoint = "bgfx_encoder_set_compute_indirect_buffer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern void encoder_set_compute_indirect_buffer(ref Encoder _this, byte _stage,
        ...
        public static extern void encoder_set_image(ref Encoder _this, byte _stage, TextureHandle _handle, byte _mip,
        ...
        public static extern void encoder_dispatch(ref Encoder _this, ushort _id, ProgramHandle _program, uint _numX,
            uint _numY, uint _numZ);
        ...
        public static extern void encoder_dispatch_indirect(ref Encoder _this, ushort _id, ProgramHandle _program,
        ...
        public static extern void encoder_blit(ref Encoder _this, ushort _id, TextureHandle _dst, byte _dstMip,
        ...
        /// <param name="dst">Destination texture handle.</param>
        /// <param name="_dstMip">Destination texture mip level.</param>
        /// <param name="_dstX">Destination texture X position.</param>
        /// <param name="_dstY">Destination texture Y position.</param>
        /// <param name="_dstZ">If texture is 2D this argument should be 0. If destination texture is cube this argument represents destination texture cube face. For 3D texture this argument represents destination texture Z position.</param>
        ...
        public static extern void blit(ushort id, TextureHandle dst, byte _dstMip, ushort _dstX, ushort _dstY,
        ...
        {
            public fixed ushort ushort0[85];
        ...
        public struct InternalData
        {
            ...
            public unsafe ref Caps caps => ref Unsafe.AsRef<Caps>(_caps.ToPointer());
        ...
        {
            private IntPtr data;
            public unsafe ref byte[] Data => ref Unsafe.AsRef<byte[]>(data.ToPointer());
        ...
        public struct Stats
        {
            ...
            public IntPtr _viewStats;
            public unsafe ref ViewStats viewStats => ref Unsafe.AsRef<ViewStats>(_viewStats.ToPointer());
            public byte numEncoders;
            private IntPtr _encoderStats;
            public unsafe ref EncoderStats encoderStats => ref Unsafe.AsRef<EncoderStats>(_encoderStats.ToPointer());
